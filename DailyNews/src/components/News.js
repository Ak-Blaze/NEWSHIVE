...
class News extends React.Component {
    ...
    updateItem = async () => {
        let url = this.props.q ? `https://newsapi.org/v2/everything?q=${this.props.q}&apiKey=7bc58132a8be40e78f2eb9f3b1aae558&page=${this.state.page}&pageSize=${this.props.pageSize}
